...
const ObjectItem = ({ object }: Props) => {
  ...
  return (
    <Link
      className="bg-secondary flex flex-row rounded-2xl mt-4 p-4"
    ...
    >
      ...
      <div className="flex flex-col ml-4">
        ...
        <div className="text-text font-primary">{description}</div>
        <div className="flex items-center">
          <svg
            className="w-4 h-4 text-[#F7B610] ms-1"
            aria-hidden="true"
          ...
          <svg
            className="w-4 h-4 ms-1 text-[#F7B610] dark:text-gray-500"
            aria-hidden="true"
            xmlns="http://www.w3.org/2000/svg"
            fill="currentColor"
            viewBox="0 0 22 20"
